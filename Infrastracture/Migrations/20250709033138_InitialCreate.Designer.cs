...
namespace Messenger.Migrations
{
    ...
    [Migration("20250709033138_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.Domain.Models.IncomingMessage", b =>
                {
                    ...
                    b.Property<Guid>("OutcomingMessageId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Messenger.Domain.Models.IncomingMessage", b =>
                {
                    b.HasOne("Messenger.Domain.Models.OutgoingMessage", "OutcomingMessage")
                        .WithMany("IncomingMessages")
                        .HasForeignKey("OutcomingMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
